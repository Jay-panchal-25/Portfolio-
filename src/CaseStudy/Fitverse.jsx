        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-6">
          {[
            ...
            <motion.div
              ...
              custom={i}
              className={`relative h-full p-6 bg-white rounded-2xl border border-gray-200 shadow-[0_8px_30px_rgba(0,0,0,0.05)] hover:shadow-[0_12px_35px_rgba(0,0,0,0.08)] transition duration-300 ease-in-out ${span}`}
            >
